...
## Week 2 — Servo Upgrade Attempt (Day 2 progress)
...
**Maintainer note:** Day 2 documentation and upgrade preparation advanced. Actual Servo `rev` bump still pending a chosen intermediate target.
